...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Back-end Software Developer 🚀 having an experience of building Web and Mobile applications with JavaScript / NodeJs / NestJs / Web3 / Python and some other cool libraries and frameworks."
  ),
  resumeLink:
